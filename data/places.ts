...
export const ABANDONED_PLACES: AbandonedPlace[] = [
  {
    id: 'example-1',
    title: 'Заброшенная текстильная фабрика',
    description: 'Старая текстильная фабрика времен СССР, закрытая в начале 90-х годов. Большое промышленное здание с частично сохранившимся оборудованием. Интересные граффити на стенах. Здание находится в относительно хорошем состоянии, но требует осторожности при исследовании из-за старых конструкций.',
    images: [
